...
const filteredPatients = computed(() => {
  ...
  return (data.value?.data || []).filter((patient) => {
    return (
      patient.patient_name.toLowerCase().includes(q.value.toLowerCase()) ||
...
<template>
  <div>
    <UPageCard
      title="Patients"
      description="Here you can see all the patients in the system. Who had completed their treatment and are fully recovered."
      variant="naked"
